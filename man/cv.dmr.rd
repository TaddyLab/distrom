...
multinomial deviance under different penalty weights.  Note that model selection
...
shows mean OOS multinomial deviance with 1se error bars.  
In addition, \code{logLik.cv.dmr} allows for \code{AIC} calculations
